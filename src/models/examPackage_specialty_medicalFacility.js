...
module.exports = (sequelize, DataTypes) => {
    class ExamPackage_specialty_medicalFacility extends Model {
        ...
        static associate(models) {
            ...
            ExamPackage_specialty_medicalFacility.hasMany(models.ExamPackage_booking, {
                as: "bookings",
                foreignKey: "examPackageId",
            });
            ExamPackage_specialty_medicalFacility.hasMany(models.ExamPackage_result_template, {
                as: "resultTemplates",
                foreignKey: "examPackageId",
            });
        }
