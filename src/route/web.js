...
let initWebRoutes = (app) => {
  ...
  router.get(
    ...
    userController.handleGetAllUsersForReact
  );
  router.post(
    "/api/create-new-user-in-react",
    userController.handleCreateNewUserInReact
  );
  router.put("/api/edit-user-in-react", userController.handleEditUserInReact);
  router.delete(
    "/api/delete-user-in-react",
    userController.handleDeleteUserInReact
  );
  router.get(
    "/api/check-user-email-already-exist",
    userController.checkEmailWetherAlreadyExist
  );

  router.get("/api/getallcodesdata", userController.getAllCodesData);
  //lấy bác sĩ nổi bật cho trang home
  router.get(
    "/api/get-elite-doctor-for-homepage",
    doctorController.getEliteDoctorForHomePage
  );
  //lấy ra tất cả bác sĩ để cho vào Select trong trang doctorArticle
  router.get(
    "/api/get-all-doctors-for-doctor-article-page",
    doctorController.getAllDoctorsForDoctorArticlePage
  );
  //lưu bài báo của một bacs sĩ
  router.post(
    "/api/save-infor-and-article-of-a-doctor",
    doctorController.saveInforAndArticleOfADoctor
  );
  //lấy thông tin map từ 2 bảng user và markdown với key=doctorId để hiển thị thông tin bác sĩ
  router.get(
    "/api/get-a-particular-doctor-infor-for-his-or-her-page",
    doctorController.getParticularInforForDoctorPage
  );
  //tạo một schedule cho 1 bac sĩ, một schedule có nhiều timeframe
  router.post(
    "/api/bulk-create-timeframes-for-doctor-appointment-schedule",
    doctorController.createTimeframesForDoctorSchedule
  );
  ...
  router.get(
    "/api/all-medical-services-filter-search",
    searchController.allMedicalServiceFilterSearch
  );

  //lưu bệnh nhân và thông tin đặt lịch khám với bác sĩ
  router.post(
    "/api/patient-infor-when-booking-time",
    patientController.patientInforWhenBookingTime
  );
  router.post(
    "/api/patient-infor-when-booking-exam-package",
    medicalFacilityController.patientInforWhenBookingExamPackage
  );
  //trang web xác nhận chốt đặt lịch
  router.post(
    "/api/confirm-booking-appointment",
    patientController.confirmBookingAppointment
  );
  ...
  router.get(
    ...
    specialtyController.getSpecialtyAndProvinceForMedicalFacilityManagePage
  );
  ...
  router.get(
    "/api/get-all-relative-infors-of-current-system-user",
    userController.getAllRelativeInforsOfCurrentSystemUser
  );
  router.get(
    "/api/get-all-relative-bookings-of-current-system-user",
    userController.getAllRelativeBookingsOfCurrentSystemUser
  );

  router.post(
    "/api/save-appointment-history",
    doctorController.saveAppointmentHistory
  );
  //lấy thông tin trong bảng history
  router.get(
    "/api/get-appointement-histories-by-doctor-email",
  ...
  router.get(
    "/api/get-info-of-medical-facility",
    medicalFacilityController.getInfoOfMedicalFacility
  );
  //tạo mới một gói khám cho một cơ sở y tế
  router.post(
    "/api/create-exam-package",
    medicalFacilityController.createExamPackage
  );
  //lấy thông tin tất cả các Gói khám
  router.get(
    "/api/get-all-exam-package",
    medicalFacilityController.getAllExamPackage
  );
  //tạo lịch khám cho gói khám
  router.post(
    "/api/bulk-create-timeframes-for-exam-package-schedule",
    medicalFacilityController.createTimeframesForExamPackageSchedule
  );
  //lấy các khung giờ khám của một gói khám
  router.get(
    "/api/get-package-schedule-by-date",
    medicalFacilityController.getPackageScheduleByDate
  );
