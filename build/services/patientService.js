...
var _sendEmailService = _interopRequireDefault(require("./sendEmailService"));
...
var buildUrlConfirmMedicalRecord = function buildUrlConfirmMedicalRecord(doctorId, token) {
  var result = "".concat(process.env.URL_REACT_SERVER, "/confirm-booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return result;
};
var patientInforWhenBookingTimeService = function patientInforWhenBookingTimeService(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var doctorInfor, token, patient;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            doctorInfor = _context.sent;
            token = (0, _uuid.v4)(); // ⇨ '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d'
            _context.next = 11;
            return _sendEmailService["default"].sendAEmail({
...
var confirmBookingAppointmentService = function confirmBookingAppointmentService(data) {
  return new Promise(/*#__PURE__*/function () {
