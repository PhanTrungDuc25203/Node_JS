...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //trong file này có phần so sánh password để kiểm tra người dùng
...
var getAllUsersForReact = function getAllUsersForReact(userId) {
    ...
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            users = ''; //trả về ít thông tin người dùng thôi không lộ hết:))
            if (userId === 'ALL') {
...
var createNewUserInReact = function createNewUserInReact(data) {
...
var editUserInReact = function editUserInReact(data) {
  return new Promise(/*#__PURE__*/function () {
...
var deleteUserInReact = function deleteUserInReact(userIdFromReact) {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            break;
          case 5:
            res = {}; //tên db.Allcode không liên quan tới db trong phpmyadmin, nó được định nghĩa bên trong model
            //của project này
            _context8.next = 8;
...
var getAllRelativeInforsOfCurrentSystemUserService = function getAllRelativeInforsOfCurrentSystemUserService(currentUserEmail) {
  return new Promise(/*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
      var res, userInUserTable;
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 8:
            userInUserTable = _context9.sent;
            if (userInUserTable) {
              // Format lại các trường date và patientBirthday
              if (userInUserTable.doctorHasAppointmentWithPatients) {
                userInUserTable.doctorHasAppointmentWithPatients.forEach(function (appointment) {
                  appointment.date = (0, _moment["default"])(appointment.date).format('YYYY-MM-DD');
                  appointment.patientBirthday = (0, _moment["default"])(appointment.patientBirthday).format('YYYY-MM-DD');
                });
              }
              if (userInUserTable.patientHasAppointmentWithDoctors) {
                userInUserTable.patientHasAppointmentWithDoctors.forEach(function (appointment) {
                  appointment.date = (0, _moment["default"])(appointment.date).format('YYYY-MM-DD');
                  appointment.patientBirthday = (0, _moment["default"])(appointment.patientBirthday).format('YYYY-MM-DD');
                });
              }
